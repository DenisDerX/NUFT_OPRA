...
start: // початок виведення меню на екран
    ...
    cout << " |  6. Списку гелікоптерів із заданою вантажопідйомністю                       |\n";
    cout << " |  7. Список гелікоптерів гелікоптерів заданого типу                          |\n";
    cout << " |  8. Список гелікоптерів із заданими кількістю пасажирських місць і типу     |\n";
    cout << " |  9. Список гелікоптерів заданого виробника                                  |\n";
    cout << " | 10. Список гелікоптерів, які випустили у заданий період                     |\n";
    cout << " | 11. Виведення списку гелікоптерів, які випустили у заданий період           |\n";
    cout << " | 12. Вихiд                                                                   |\n";
    cout << " |=============================================================================|\n";
