...
const int countZinP = 30; // оголошуємо константу, що регламентує кількість записів на екрані
...
start:
    ...
    {
        printf("|   |%.10s      |%10s |%10s |%9d                     |%10s|%9d                  |\n", zap.year, zap.producer, zap.name, zap.nam, zap.type, zap.weight);
    }
    cout << "|___|_______________|______________________________|______________________________|______________________________|_____________________________|___________________________|\n";
...
//Процедура виводу списку гелікоптерів гелікоптерів за вантажопідйомністю
void tsk3()
{
l1:
    system("cls");
...
// Процедура для виводу списку гелікоптерів, що випустили до/після заданого року
void tsk5()
{
l1:
    system("cls");
